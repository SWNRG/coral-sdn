...
<simconf>
  ...
  <simulation>
    ...
    <radiomedium>
      ...
      <success_ratio_tx_lr>0.0</success_ratio_tx_lr>
    ...
    <mote>
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>21.58477450169702</x>
        <y>16.453904735623325</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.contikimote.interfaces.ContikiMoteID
  ...
  <plugin>
    ...
    <plugin_config>
      ...
      <viewport>1.5139535814125638 0.0 0.0 1.5139535814125638 120.7941157702083 87.88517021651123</viewport>
    </plugin_config>
    <width>400</width>
    <z>8</z>
    <height>400</height>
